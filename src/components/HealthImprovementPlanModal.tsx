  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto sm:max-w-[95vw]">
        ...
        <button 
          onClick={onClose}
          className="md:hidden absolute top-3 right-3 z-50 w-10 h-10 flex items-center justify-center rounded-full bg-card shadow-lg border border-border hover:bg-card/[0.05] transition-colors"
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {plan.specialistReferrals.map((referral, idx) => (
                        <div key={idx} className="bg-card border border-white/10 rounded-lg p-3">
