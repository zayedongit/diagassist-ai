...
export const SystemScoreBreakdown = ({ breakdown }: SystemScoreBreakdownProps) => {
  ...
  return (
    <div className="space-y-4">
      <h4 className="font-semibold text-navy text-lg">Detailed System Analysis</h4>
          ...
          return (
            ...
            >
              <AccordionTrigger className="hover:no-underline">
                <div className="flex items-center gap-3 w-full">
                  ...
                  <div className="flex-1 text-left">
                    <div className="font-semibold text-slate">{getSystemLabel(systemName)}</div>
              ...
              <AccordionContent className="pt-4 space-y-4">
                ...
                <div>
                  <h5 className="text-sm font-semibold text-navy mb-2">Parameters Evaluated</h5>
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mt-4">
        <h5 className="text-sm font-semibold text-navy mb-2">Medical Guidelines Referenced</h5>
