...
export const generateMockPdf = async () => {
  try {
    ...
    const disclaimerText = "This is a comprehensive sample report demonstrating DAIG ASSIST's advanced AI analysis capabilities using anonymized patient data. This report is generated using artificial intelligence and is intended for informational and demonstration purposes only. It should not replace professional medical advice, diagnosis, or treatment. Always consult with qualified healthcare professionals for medical concerns. Patient identity has been masked for privacy protection. This sample showcases the depth and quality of analysis provided by our AI system.";
